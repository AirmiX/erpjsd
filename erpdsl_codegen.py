...
def main(debug=False):
    ...
    # Instantiate the erpdsl meta-model
    erpdsl_mm = get_erpdsl_mm()
...
#        return False
    ...
    # Register the filter for mapping erpdsl type names to Java type names.
    ...
    # Build a test model from erpdsl.edl file
